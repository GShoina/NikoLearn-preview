...
| MC-2 | ფორმების სამყარო (figures + classification, ეროვნ. μ24) | WEDGE | NEW | very visual; §11 original content |
...
| MC-6 | უნარების რუკა / skill-map view | engine | NEW | Khan's one real lesson we lack; reuse W5 grid pattern; ties to Marble #4 DAG |
