...
function openLangPicker(e){
  ...
  back.innerHTML='<div class="langpick" role="menu" aria-label="ინტერფეისის ენა / interface language">'
    +'<button role="menuitemradio" aria-checked="'+(!en)+'" class="lp-opt'+(en?'':' on')+'" onclick="pickLang(\'ka\')"><span class="lang-code">KA</span> ქართული</button>'
    +'<button role="menuitemradio" aria-checked="'+en+'" class="lp-opt'+(en?' on':'')+'" onclick="pickLang(\'en\')"><span class="lang-code">EN</span> English</button>'
    +'</div>';
