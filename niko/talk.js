...
const TALK = {
  ka:[
    {theme:'think',   emoji:'☁️🍬', by:'owl',   q:'რა მოხდებოდა, ღრუბლები ტკბილეულისგან რომ ყოფილიყვნენ? შენ რას გააკეთებდი?', subs:['ახლა შენ მოიგონე ერთი „რა მოხდება, თუ..." კითხვა.']},
    ...
    {theme:'values',  emoji:'🌍', by:'owl',   q:'მთელ მსოფლიოს ერთ წესს რომ უწესებდე, რა იქნებოდა?', subs:['ეს წესი შენც მოგეწონებოდა?']},
    ...
    {theme:'think',   emoji:'🙃', by:'niko',  q:'დილით რომ გაიღვიძო და ყველაფერი თავდაყირა დაგხვდეს, რას იზამდი?', subs:[]},
    {theme:'bedtime', emoji:'💬', by:'owl',   q:'დაძინებამდე მხოლოდ ერთი სიტყვის თქმა რომ შეგეძლოს, რას იტყოდი?', subs:[]},
    ...
    // ── v1.318 — Fable5 batch (owner-approved 2026-07-02): 20 new ka cards, placed into our schema + graded
    //    by `min` (abstract hypotheticals = 5+, concrete/EQ = all ages). #8 reworded per QA. Clips tlk_051-070 pending. ──
    {theme:'imagine', emoji:'🛏️✨', by:'niko',  q:'შენი საწოლი ღამით რომ დაფრინავდეს, დილამდე სად წაგიყვანდა?', subs:['ვის წაიყვანდი თან ამ მოგზაურობაში?'], min:5},
    {theme:'bedtime', emoji:'😮',    by:'owl',   q:'დღეს რამ გაგაკვირვა ყველაზე მეტად?', subs:[]},
    {theme:'imagine', emoji:'🌱✨',  by:'masho', q:'ჯადოსნური თესლი რომ დათესო, დილით მიწიდან რა ამოვიდოდა?', subs:[], min:5},
    {theme:'values',  emoji:'👵',    by:'niko',  q:'ბებიას ან ბაბუას ბავშვობაზე რას ჰკითხავდი?', subs:['რით შეიძლება განსხვავდებოდა მათი ბავშვობა შენსგან?']},
    {theme:'imagine', emoji:'🐻',    by:'owl',   q:'ცხოველებს სკოლა რომ ჰქონდეთ, დათუნია პირველ გაკვეთილზე რას ისწავლიდა?', subs:[], min:5},
    {theme:'values',  emoji:'🙏',    by:'masho', q:'დღეს ვის ეტყოდი მადლობას და რისთვის?', subs:[]},
    {theme:'whatif',  emoji:'❄️☀️',  by:'owl',   q:'ზამთარი და ზაფხული რომ შეხვდნენ, ერთმანეთს რას მოუყვებოდნენ?', subs:[], min:5},
    {theme:'values',  emoji:'💙',    by:'masho', q:'როცა გეწყინება, რა გამშვიდებს ხოლმე?', subs:[]},
    {theme:'imagine', emoji:'🌙🎁',  by:'owl',   q:'მთვარისთვის საჩუქრის გაგზავნა რომ შეგეძლოს, რა გაუხარდებოდა ყველაზე მეტად?', subs:[], min:5},
    {theme:'think',   emoji:'👃',    by:'niko',  q:'რომელი სუნი გიყვარს ყველაზე მეტად და რას გახსენებს?', subs:[]},
    {theme:'imagine', emoji:'🍓',    by:'masho', q:'ახალი ხილი რომ გამოიგონო, როგორი გემო და ფერი ექნებოდა?', subs:['რა დაარქმევდი?'], min:5},
    {theme:'values',  emoji:'💪',    by:'owl',   q:'როცა რამე არ გამოგდის, ისევ რომ სცადო, რა გეხმარება?', subs:[]},
    {theme:'imagine', emoji:'⛰️',    by:'niko',  q:'მთის წვერზე რომ ახვიდე, იქიდან მთელ ქვეყანას რას დაუძახებდი?', subs:[], min:5},
    {theme:'think',   emoji:'🍳',    by:'masho', q:'ერთ დილას საუზმე შენ რომ მოამზადო, ოჯახს რას შესთავაზებდი?', subs:[]},
    {theme:'imagine', emoji:'🏕️',    by:'owl',   q:'საიდუმლო ქოხს რომ ააშენებდი, შიგნით რას შეინახავდი?', subs:[], min:5},
    {theme:'values',  emoji:'✉️',    by:'niko',  q:'წერილი რომ დაწერო და კონვერტში ჩადო, ვის გაუგზავნიდი?', subs:['რას დაწერდი შიგნით?']},
    {theme:'think',   emoji:'🏷️',    by:'masho', q:'ერთი დღით სახელს რომ იცვლიდე, რას დაირქმევდი?', subs:[]},
    {theme:'values',  emoji:'🐱',    by:'owl',   q:'ეზოში პატარა კნუტი რომ შეგხვდეს, როგორ დაუმეგობრდებოდი?', subs:[]},
    {theme:'imagine', emoji:'🎵',    by:'niko',  q:'შენი საკუთარი სიმღერა რომ მოიგონო, რაზე იმღერებდი?', subs:[], min:5},
    {theme:'imagine', emoji:'🍎',    by:'masho', q:'ერთი დღით მასწავლებელი რომ იყო, ბავშვებს რას ასწავლიდი?', subs:[], min:5}
  ],
  en:[
