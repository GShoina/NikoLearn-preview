...
window.I18N_PATTERNS = [
  ...
  [new RegExp("^დააკვირდი სურათს: (.+?)\\. რას ხედავ\\?$"), m=>`Look at the picture: ${m[1]}. What do you see?`],
...
Object.assign(window.I18N_MAP, {
  ...
  "პროგრესი ამ მოწყობილობაზე ვერ ინახება":"Progress cannot be saved on this device",
  "ბრაუზერმა შენახვა დაბლოკა. ეს ხდება პრივატულ რეჟიმში ან როცა ადგილი ამოიწურა. თამაში მუშაობს, მაგრამ დღევანდელი შედეგი დახურვისას დაიკარგება.":"Your browser blocked saving. This happens in private mode, or when storage is full. Play still works, but today's results will be lost when you close the app.",
