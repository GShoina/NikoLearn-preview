...
window.I18N_MAP = {
  ...
  "ℹ️ ეს რიცხვები მხოლოდ ამ მოწყობილობას ეხება. ყველა მოწყობილობის ნამდვილ რიცხვებს ქვემოთ ხედავ.":"ℹ️ These numbers are for this device only. You'll see the real numbers across all devices below.",
  "📊 GA4, სრული რეპორტი":"📊 GA4, full report",
  "← აპში დაბრუნება":"← Back to the app",
  "ადმინიდან გასვლა (კოდის თავიდან შეყვანა)":"Sign out of admin (enter the code again)",
  "📈 ცოცხალი GA4 რიცხვები მალე ჩაირთვება (proxy deploy მიმდინარეობს). მანამდე, „სრული რეპორტი\" ღილაკი.":"📈 Live GA4 numbers are coming soon (proxy deploy is in progress). Until then, use the \"full report\" button.",
  "⏳ GA4 რიცხვები იტვირთება…":"⏳ Loading GA4 numbers…",
  "GA4 ვერ ჩაიტვირთა, სცადე „სრული რეპორტი\".":"GA4 didn't load, try the \"full report\" button.",
  "მომხ. დღეს":"Users today",
  "რეგ. დღეს":"Sign-ups today",
  "მომხ. 7 დღე":"Users, 7 days",
  "რეგ. 7 დღე":"Sign-ups, 7 days",
