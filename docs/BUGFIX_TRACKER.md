...
| NB-19 | English section has many bugs too (owner report, unspecified) — pre-reader pass so far only swept ka/math/shapes; EN modes NOT audited at same depth | owner 2026-07-07 | OPEN | needs full EN-section §14 sweep next session (enumerate live EN menu, run each mode, screenshot). Owner-reported = treat as real. |
