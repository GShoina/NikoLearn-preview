...
Q=[
 ...
 'ჯიბეში პატარა დრაკონი რომ გეპოვა, რას დაარქმევდი და რას აჭმევდი?',
 'ეზოში ახალი ბავშვი მარტო დგას — შენ რას იზამდი?',
 'ცის ერთ ვარსკვლავს ქილაში რომ დაიჭერდი, მის შუქს რას უზამდი?',
 'ყველაზე სასაცილო ზებუნებრივი ძალა რომელი იქნებოდა?',
 ...
 'დილით რომ გაიღვიძებდი და ყველაფერი თავდაყირა იყოს, რას იზამდი?',
